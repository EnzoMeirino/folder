...
const TelaInicial = memo(() => {
  ...
  return (
    ...
    >
      ...
      <Pressable 
      style={[styles.registerButton, styles.buttonLayout]} 
      onPress={() => navigation.navigate("Register")}> 
       <View style={[styles.registerButtonChild, styles.buttonChildPosition]}/>
       <Text style={[styles.registrarSe, styles.loginTypo]}>Registrar-se</Text>
      </Pressable>
